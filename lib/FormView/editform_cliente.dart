...
class EditFormClientes extends StatefulWidget {
  const EditFormClientes({super.key});

  @override
  State<EditFormClientes> createState() => _EditFormClientesState();
}

class _EditFormClientesState extends State<EditFormClientes> {
  ...
  Widget build(BuildContext context) {
    ...
    nombrecontroller.text = arguments['nombres'];
